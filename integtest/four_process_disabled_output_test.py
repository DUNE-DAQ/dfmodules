...
nanorc_command_list="boot init conf start --disable-data-storage 101 resume wait 20 pause stop wait 3 start 101 resume wait 20 pause stop wait 3 start --disable-data-storage 101 resume wait 20 stop wait 3 start 101 resume wait 20 stop wait 3 scrap terminate".split()
