...
ignored_logfile_problems={"trigger": ["zipped_tpset_q: Unable to push within timeout period"], "hsi": ["Trigger Matching result with empty fragment", "Request on empty buffer: Data not found"]}
