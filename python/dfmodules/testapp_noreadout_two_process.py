...
if __name__ == '__main__':
    ...
    def cli(number_of_data_producers, data_rate_slowdown_factor, run_number, trigger_rate_hz, data_file, output_path, disable_data_storage, host_ip_df, host_ip_trigemu, json_file_base):
        """
