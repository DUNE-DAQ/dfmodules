...
moo.otypes.load_types('dfmodules/datagenerator.jsonnet')
...
import dunedaq.dfmodules.datagenerator as dgen
...
def generate(
    ...
    mod_specs = [mspec("dataxfer", "DataGenerator", []),]
    ...
    confcmd = mrccmd("conf", "INITIAL", "CONFIGURED",[
                ("dataxfer", dgen.ConfParams(
                            geo_location_count = 2,
                            io_size = 1048576,
...
if __name__ == '__main__':
    ...
    @click.argument('json_file', type=click.Path(), default='data_generator_demo.json')
