...
local info = {
   ...
   info: s.record("Info", [
       s.field("heartbeats_received", self.uint8, 0, doc="Number of received heartbeats"),
       ...
       s.field("waiting_for_heartbeat", self.uint8, 0, doc="Time spent waiting in heartbeat thread for heartbeats"),
       s.field("processing_heartbeat", self.uint8, 0, doc="Time spent in heartbeat thread updating data structure"),
