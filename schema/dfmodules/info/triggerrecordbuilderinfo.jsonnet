...
local info = {
   ...
   info: s.record("Info", [
       ...
       s.filed("data_waiting_time", self.uint8, 0, doc="Time of TRs spent in the TRB buffer"),
       s.filed("data_request_width", self.uint8, 0, doc="total time window requested to readout"),
       s.filed("trigger_decision_width", self.uint8, 0, doc="total time window requested from a trigger decision"),
