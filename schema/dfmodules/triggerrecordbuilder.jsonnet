...
local s_requesttypes = import "dfmessages/requesttypes.jsonnet";
local ns = "dunedaq.dfmodules.triggerrecordbuilder";
local s = moo.oschema.schema(ns);
local requesttypes = moo.oschema.hier(s_requesttypes).dunedaq.dfmessages.requesttypes;
...
local types = {
    ...
    conf: s.record("ConfParams", [ s.field("map", self.mapgeoidqueue, doc="" ), 
	                           ...
	                           s.field("data_request_mode", requesttypes.requesttype, "kDFReadout", 
