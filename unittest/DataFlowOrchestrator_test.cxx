...
struct ConfigurationTestFixture
{
  ConfigurationTestFixture()
  {
    ...
    connections.emplace_back(dunedaq::iomanager::ConnectionId{ "test.trigdec_0_s",
                                                               dunedaq::iomanager::ServiceType::kNetSender,
                                                               "dfmessages::TriggerDecision",
                                                               "tcp://127.0.0.10:5050" });
    connections.emplace_back(dunedaq::iomanager::ConnectionId{ "test.trigdec_s",
                                                               dunedaq::iomanager::ServiceType::kNetSender,
                                                               "dfmessages::TriggerDecision",
                                                               "inproc://trigdec" });
    connections.emplace_back(dunedaq::iomanager::ConnectionId{ "test.triginh_s",
                                                               dunedaq::iomanager::ServiceType::kNetSender,
                                                               "dfmessages::TriggerInhibit",
                                                               "inproc://triginh" });
    connections.emplace_back(dunedaq::iomanager::ConnectionId{ "test.token_s",
                                                               dunedaq::iomanager::ServiceType::kNetSender,
                                                               "dfmessages::TriggerDecisionToken",
                                                               "inproc://token" });
    connections.emplace_back(dunedaq::iomanager::ConnectionId{ "test.trigdec_r",
                                                               dunedaq::iomanager::ServiceType::kNetReceiver,
                                                               "dfmessages::TriggerDecision",
                                                               "inproc://trigdec" });
    connections.emplace_back(dunedaq::iomanager::ConnectionId{ "test.triginh_r",
                                                               dunedaq::iomanager::ServiceType::kNetReceiver,
                                                               "dfmessages::TriggerInhibit",
                                                               "inproc://triginh" });
    connections.emplace_back(dunedaq::iomanager::ConnectionId{ "test.token_r",
                                                               dunedaq::iomanager::ServiceType::kNetReceiver,
                                                               "dfmessages::TriggerDecisionToken",
                                                               "inproc://token" });
    connections.emplace_back(dunedaq::iomanager::ConnectionId{ "test.trigdec_0_r",
                                                               dunedaq::iomanager::ServiceType::kNetReceiver,
                                                               "dfmessages::TriggerDecision",
                                                               "tcp://127.0.0.10:5050" });
    connections.emplace_back(dunedaq::iomanager::ConnectionId{ "trigger_decision_q",
                                                               dunedaq::iomanager::ServiceType::kQueue,
                                                               "dfmessages::TriggerDecision",
                                                               "queue://FollySPSCQueue:1" });
  ...
  static nlohmann::json make_init_json()
  {
    ...
    data.conn_refs.emplace_back(dunedaq::iomanager::ConnectionRef{ "td_connection", "test.trigdec_r" });
    data.conn_refs.emplace_back(dunedaq::iomanager::ConnectionRef{ "token_connection", "test.token_r" });
    data.conn_refs.emplace_back(dunedaq::iomanager::ConnectionRef{ "busy_connection", "test.triginh_s" });
    nlohmann::json json;
...
send_token(dfmessages::trigger_number_t trigger_number,
           std::string connection_name = "test.trigdec_0_s",
